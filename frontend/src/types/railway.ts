...
export type RailwayFeature = Feature<
	LineStringGeometry,
	RailwaySegmentProperties
>;
export type RailwayChunkFeature = Feature<
	LineStringGeometry,
...
export type RailwayChunkFeatureCollection =
	FeatureCollection<RailwayChunkFeature>;
